        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-xl border border-border">
            ...
            <div className="p-4 grid grid-cols-2 gap-3">
              <Link to="/dashboard/chat?mode=validate-idea" className="p-4 rounded-lg bg-role-founder/10 hover:bg-role-founder/20 transition-colors border border-role-founder/20">
              ...
              <Link to="/dashboard/chat?mode=build-roadmap" className="p-4 rounded-lg bg-violet-500/10 hover:bg-violet-500/20 transition-colors border border-violet-500/20">
              ...
              <Link to="/dashboard/chat?mode=tech-stack" className="p-4 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 transition-colors border border-cyan-500/20">
                <Code2 className="w-6 h-6 text-cyan-400 mb-2" />
                <p className="font-medium">Tech Stack</p>
                <p className="text-xs text-muted-foreground">Get recommendations</p>
              </Link>
              <Link to="/dashboard/chat?mode=pitch-deck" className="p-4 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 transition-colors border border-emerald-500/20">
